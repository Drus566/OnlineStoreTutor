...
# Note that we place the set_cart method in a CurrentCart module and place that
# module in a new file in the app/controllers/concerns directory. [51] This treatment
# allows us to share common code (even as little as a single method!) among
# controllers