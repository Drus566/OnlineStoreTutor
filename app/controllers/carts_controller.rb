class CartsController < ApplicationController
  ...
  before_action :invalid_access_to_cart, only: [:show, :edit, :update, :destroy]
  ...
  private
    ...
    def invalid_access_to_cart
      unless @cart.id == session[:cart_id]
        respond_to do |format|
          format.html { redirect_to store_index_url, notice: 'Invalid access to cart' }
          format.json { head :no_content }
        end
      end
    end
